...
class Simutar_m extends CI_Model{
	public $_tq         = "simutar_detail";//tabel query
    public $_tq_s       = "simutar_mutakhir";
    public $_orderby    = "ASC";
    ...
    public function jum_pindah_tps($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi){
        $this->db->select("id");
        $this->db->from($this->_tq);
        ...
        $this->db->where("verval","MS");
        $this->db->where("variansi_data","Pemilih Pindah TPS");
    ...
    public function jum_meninggal($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi){
        ...
        $this->db->where('verval','TMS');
        $this->db->where("variansi_data","1. Meninggal Dunia");
    ...
    public function jum_ditemukan_ganda($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi){
        ...
        $this->db->where('verval','TMS');
        $this->db->where("variansi_data","2. Ditemukan Data Ganda");
    ...
    public function jum_dibawah_umur($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi){
        ...
        $this->db->where('verval','TMS');
        $this->db->where("variansi_data","3. Dibawah Umur");
    ...
    public function jum_pindah_domisili($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi){
        ...
        $this->db->where('verval','TMS');
        $this->db->where("variansi_data","4. Pindah Domisili");
    ...
    public function jum_tidak_ditemukan($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi){
        ...
        $this->db->where('verval','TMS');
        $this->db->where("variansi_data","5. Tidak Dikenal");
    ...
    public function jum_tni($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi){
        ...
        $this->db->where('verval','TMS');
        $this->db->where("variansi_data","6. TNI");
    ...
    public function jum_polri($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi){
        ...
        $this->db->where('verval','TMS');
        $this->db->where("variansi_data","7. POLRI");
    ...
    public function jum_hilang_ingatan($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi){
        ...
        $this->db->where('verval','TMS');
        $this->db->where("variansi_data","8. Hilang Ingatan");
    ...
    public function jum_hak_pilihdicabut($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi){
        ...
        $this->db->where('verval','TMS');
        $this->db->where("variansi_data","9. Hak Pilih Dicabut");
    ...
    public function jum_bukan_penduduk($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi){
        ...
        $this->db->where('verval','TMS');
        $this->db->where("variansi_data","10. Bukan Penduduk");
    ...
    public function fetch_details($limit, $start, $namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$mylink,$jns_variansi){
        ...
        $this->db->select("a.id,a.id oke,a.no_kk,a.nik, a.nm_lengkap, LPAD(s.no_tps,2,0)tps,s.no_tps,s.petugas,
                             ...
                             a.sts_perkawinan, a.jns_kelamin,a.prekaman_ektp,if(a.dp_id='','-',a.dp_id)dpid,
                             ...
                             if(a.verval='MS' AND a.variansi_data='','success',if(a.verval='MS' AND a.variansi_data='Pemilih Baru','info',if(a.verval='MS' AND a.variansi_data='Pemilih Ubah Data','warning',if(a.verval='MS' AND a.variansi_data='Pemilih Pindah TPS','warning',if(a.verval='TMS','danger','')))))vars,
                             if(a.variansi_data='','<span class=\"label label-success\">Lengkap</span>',
                             ...
                             if(a.variansi_data='1. Meninggal Dunia','<span class=\"label label-danger\">Meninggal</span>',
                             if(a.variansi_data='2. Ditemukan Data Ganda','<span class=\"label label-danger\">Ganda</span>',
                             if(a.variansi_data='3. Dibawah Umur','<span class=\"label label-danger\">Bwh. Umur</span>',
                             if(a.variansi_data='4. Pindah Domisili','<span class=\"label label-danger\">Pindah</span>',
                             if(a.variansi_data='5. Tidak Dikenal','<span class=\"label label-danger\">Tdk. Dikenal</span>',
                             if(a.variansi_data='6. TNI','<span class=\"label label-danger\">TNI</span>',
                             if(a.variansi_data='7. POLRI','<span class=\"label label-danger\">POLRI</span>',
                             if(a.variansi_data='8. Hilang Ingatan','<span class=\"label label-danger\">Hlg. Ingatan</span>',
                             if(a.variansi_data='9. Hak Pilih Dicabut','<span class=\"label label-danger\">Dicabut</span>',
                             if(a.variansi_data='10. Bukan Penduduk','<span class=\"label label-danger\">Bkn. Penduduk</span>','')))))))))))))variansi,
    ...
    public function checktps2($tps2){
        $query = $this->db
            ->select("id,LPAD(no_tps,2,'0')notps")
            ->where("no_tps",$tps2)
            ->limit(1)
            ->get($this->_tps);
        return $query->row_array();
