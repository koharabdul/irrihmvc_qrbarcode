                        ...
                        <div class="row" style="padding-bottom: 0px;">
                            ...
                            <div class="col-sm-2">
                                <select class="chosen-select" tabindex="9" id="jns_variansi">
                                    ...
                                    <option value="Pemilih Pindah TPS">Pemilih Pindah TPS</option>
            ...
            <div class="col-lg-3">
                <div class="ibox-content" >
                    <ol style="margin-left: -25px;">
                        ...
                        <li id="jum_ubah_data" style="color: #964f1d;"></li>
                        <li id="jum_pindah_tps" style="color: #e26c18;"></li>
            ...
            function load_country_data(page){
                ...
                $.ajax({
                    ...
                    success:function(data){
                        ...
                        $('#jum_pindah_tps').html('Pindah TPS = '+data.jum_pindah_tps);
