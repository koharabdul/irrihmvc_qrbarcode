            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="<?php echo base_url() ?>personil">Penduduk</a>
                        </li>
                        <li class="active">
                ...
                <div class="ibox-content">
                    <div class="row wrapper white-bg page-heading">
                        <?php $attributes = array("name" => "flatihan", "class" => "form-horizontal m-t-md");
                            echo form_open("personil/edt/$results[id_p]", $attributes);
                        ?> 
                            <div class="col-lg-6 b-r">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group date">
                                                <?php 
                                                    ...
                                                    $tanggalindo = "$results[Tanggal]-$results[Bulan]-$results[Tahun]",
                                                                     array('class' => 'form-control',
                                                                           'type' => 'text',
                                        ...
                                        <div class="col-sm-9">
                                            <?php 
                                                if($results['jns_kelamin']=='P')
                                                {
                                                    echo"
                                                        <div class='radio radio-info radio-inline'>";
                                                            echo form_radio('jns_kelamin','P','Checked');
                                                    echo"
                                                        <label for='inlineRadio1'> Perempuan </label>
                                                        </div>
                                                        <div class='radio radio-info radio-inline'>";
                                                            echo form_radio('jns_kelamin','L');
                                                    echo"
                                                ...
                                                else
                                                {
                                                    echo"
                                                        <div class='radio radio-info radio-inline'>";
                                                            echo form_radio('jns_kelamin','P');
                                                    echo"
                                                        <label for='inlineRadio1'> Perempuan </label>
                                                        </div>
                                                        <div class='radio radio-info radio-inline'>";
                                                            echo form_radio('jns_kelamin','L','Checked');
                                                    echo"
                                                        <label for='inlineRadio2'> Laki-laki </label>
                                                        </div>";
                                                }
                                    ...
                                    <div class="col-sm-9">
                                        <select class="select2_demo_1 form-control" style="padding-left: 7px;" name="rt">
                                            <?php 
                                                echo "<option value=".$results['rt'].">".$results['rt']."</option>";
                                                for($rt=1; $rt<=30; $rt++)
                                                {
                                                    if($rt!=$results['rt'])
                                                    {
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="select2_demo_1 form-control" style="padding-left: 7px;" name="rw">
                                            <?php 
                                                echo "<option value=".$results['rw'].">".$results['rw']."</option>";
                                                for($rw=1; $rw<=30; $rw++)
                                                {
                                                    if($rw!=$results['rw'])
                                                    {
                            ...
                            <div class="col-lg-6 b-r">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="select2_demo_1 form-control" style="padding-left: 7px;" name="id_desa">
                                            <?php 
                                                echo "<option value=".$results['id_d'].">".$results['nm_desa']."</option>";
                                                foreach ($results2 as $k) {
                                                    if($k->nm_desa != $results['nm_desa'])
                                                    {
                                                        echo "<option value='$k->id'>$k->nm_desa</option>";
                                                    }
                                                }
                                            ?>
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <?php 
                                            ...
                                            echo form_dropdown('agama',$options, $results['agama'],array('class' => 'select2_demo_1 form-control', 'style' => 'padding-left: 7px;'));
                                        ?>
                                        <span class="help-block" style="color:red;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="row">
                                        <?php 
                                            if($results['sts_perkawinan']=='Belum Kawin')
                                            {
                                                echo"
                                                <div class='col-sm-6'>
                                                    <div class='radio radio-info'>";
                                                         echo form_radio('sts_perkawinan','Belum Kawin','Checked');
                                                         echo" 
                                                        <label for='radio1'>
                                                            Belum Kawin
                                                        </label>
                                                    ...
                                                    <div class='radio radio-info'>";
                                                         echo form_radio('sts_perkawinan','Kawin');
                                                         echo" 
                                                        <label for='radio2'>
                                                            Kawin
                                                        </label>
                                                ...
                                                <div class='col-sm-6'>
                                                    <div class='radio radio-info'>";
                                                         echo form_radio('sts_perkawinan','Cerai Hidup'); 
                                                         echo"
                                                        <label for='radio3'>
                                                            Cerai Hidup
                                                        </label>
                                                    ...
                                                    <div class='radio radio-info'>";
                                                         echo form_radio('sts_perkawinan','Cerai Mati'); 
                                                         echo"
                                                        <label for='radio4'>
                                                            Cerai Mati
                                                        </label>
                                            ...
                                            else if($results['sts_perkawinan']=='Kawin')
                                            {
                                                echo"
                                                <div class='col-sm-6'>
                                                    <div class='radio radio-info'>";
                                                         echo form_radio('sts_perkawinan','Belum Kawin');
                                                         echo" 
                                                        <label for='radio1'>
                                                            Belum Kawin
                                                        </label>
                                                    ...
                                                    <div class='radio radio-info'>";
                                                         echo form_radio('sts_perkawinan','Kawin','Checked');
                                                         echo" 
                                                        <label for='radio2'>
                                                            Kawin
                                                        </label>
                                            ...
                                            else if($results['sts_perkawinan']=='Cerai Hidup')
                                            {
                                                echo"
                                                <div class='col-sm-6'>
                                                    <div class='radio radio-info'>";
                                                ...
                                                <div class='col-sm-6'>
                                                    <div class='radio radio-info'>";
                                                         echo form_radio('sts_perkawinan','Cerai Hidup','Checked'); 
                                                         echo"
                                                        <label for='radio3'>
                                                            Cerai Hidup
                                                        </label>
                                            ...
                                            else if($results['sts_perkawinan']=='Cerai Mati')
                                            {
                                                echo"
                                                <div class='col-sm-6'>
                                                    <div class='radio radio-info'>";
                                                ...
                                                <div class='col-sm-6'>
                                                    ...
                                                    <div class='radio radio-info'>";
                                                         echo form_radio('sts_perkawinan','Cerai Mati','Checked'); 
                                                         echo"
                                                        <label for='radio4'>
                                                            Cerai Mati
                                                        </label>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <?php 
                                            ...
                                            echo form_dropdown('pekerjaan',$options, $results['pekerjaan'],array('class' => 'select2_demo_1 form-control'));
                                        ?>
                                        <span class="help-block" style="color:red;">
