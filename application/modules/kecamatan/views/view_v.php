                            ...
                            <div id="tab-1" class="tab-pane <?php if($this->uri->segment(2)=='view'){echo'active';} ?>" >
                                ...
                                <div class="panel-body">
                                    ...
                                    <form class="form-horizontal">
                                        <b><?php input_text2('', 'Nama Kecamatan',$results['kecamatan'],true,true) ?></b>
                                        <?php input_text2('', 'Nama Kabupaten',$results['kabupaten'],true,true) ?>
                                    ...
                                    <hr class="jumbotron-hr" style="margin-top: 0px;">
                                       <?php $attributes = array("name" => $subtitle, "method" => "post", "class" => "form-horizontal");
                                        ...
                                        ?>
                                            ...
                                            <?php input_text('nama_kecamatan', 'Nama Kecamatan', $results['kecamatan'],true,false); ?>
                                            <?php input_hidden('kabupaten_id', $results['kabupaten_id']); ?>
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">Nama Kabupaten
                                                    <font color="red">&nbsp;* </font>
                                                </label>
                                                <div class="col-sm-10">
                                                    <?php 
                                                    ...
                                                    <span class="help-block m-b-none" style="color:red;">
                                                        <?php echo form_error('kabupaten_id'); ?>
                                                    </span>
                                                </div>
                                            </div>
