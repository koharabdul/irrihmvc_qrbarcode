	                                ...
	                                <div class="input-group anto">
	                                    <?php 
                                    		...
                                    		$data = array('type' => 'text',
	                                                      'placeholder' => 'Searching for '.$subtitle.' and Kabupaten',
                                                ...
                                                else
                                                {
                                                    foreach ($results as $p) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>$no</td>
                                                            <td>$p->kecamatan $p->jumlah</td>
                                                            <td>$p->kabupaten</td>
                                                            <td>"; echo date_convert($p->date_created,true); echo"</td>
                                                            <td>"; echo date_convert($p->date_modified,true); echo"</td>
    ...
    <script>
        ...
        $('#btn_add').click(function(){
            window.location.href="<?php echo base_url().strtolower($subtitle); ?>/add";
        });
