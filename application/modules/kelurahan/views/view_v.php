                            ...
                            <div id="tab-1" class="tab-pane <?php if($this->uri->segment(2)=='view'){echo'active';} ?>" >
                                ...
                                <div class="panel-body">
                                    ...
                                    <form class="form-horizontal">
                                        <b><?php input_text2('', 'Nama Kelurahan',$results['kelurahan'],true,true) ?></b>
                                        <?php input_text2('', 'Nama Kecamatan',$results['kecamatan'],true,true) ?>
                                        <?php input_text2('', 'Kel./Desa',$results['type_kelurahan'],true,true) ?>
                                    ...
                                    <hr class="jumbotron-hr" style="margin-top: 0px;">
                                       <?php $attributes = array("name" => $subtitle, "method" => "post", "class" => "form-horizontal");
                                        ...
                                        ?>
                                            ...
                                            <?php input_text('nama_kelurahan', 'Nama Kelurahan', $results['kelurahan'],true,false); ?>
                                            <?php input_hidden('kecamatan_id', $results['kecamatan_id']); ?>
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">Tipe Kelurahan
                                                    <font color="red">&nbsp;* </font>
                                                </label>
                                                <div class="col-sm-10">
                                                    <?php 
                                                        $dataarray = array('Desa' => 'Desa',
                                                                            'Kelurahan' => 'Kelurahan' );
                                                        echo"<select class='select2_demo_2 form-control' name='type_kelurahan' style='width:100%'>";
                                                        foreach ($dataarray as $k) {
                                                            if($k!=$results['type_kelurahan']){
                                                                $selected = '';
                                                            }
                                                            else{
                                                                $selected = 'selected';
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">Nama Kecamatan
                                                    <font color="red">&nbsp;* </font>
                                                </label>
                                                <div class="col-sm-10">
                                                    <?php 
