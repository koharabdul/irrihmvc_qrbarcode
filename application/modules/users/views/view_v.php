                ...
                <div class="col-lg-12">
                    <div class="tabs-container">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="<?php if($this->uri->segment(2)=='update'){echo'active';} ?>"><a data-toggle="tab" href="#tab-2"> Edit Page</a></li>
                            <li class="pull-right"><?php echo anchor(strtolower($subtitle).'/delete/'.$results['id'],'<i class="fa fa-trash"></i> Delete Page </a>',array('onclick' => "return confirm('are you sure want to delete?');")); ?>
                                </li>
                        </ul>
