...
class Daftarpemilihtetap extends MY_Controller{
	public function __construct()
  	{
  		parent::__construct();
        $this->load->model('Daftarpemilihtetap_m');//model
        $this->susbtitle = 'Daftar Pemilih Tetap';//subtitle
        $dataactiveclass = $this->susbtitle;
        $idAndPerpage = $this->Daftarpemilihtetap_m->perpageAndId($dataactiveclass);
  	...
  	public function actived_Class($dataactiveclass){
        $activeclass = $this->Daftarpemilihtetap_m->get_activedclass($dataactiveclass);
    ...
    public function index()
    {
        ...
        $data['tps'] = $this->Daftarpemilihtetap_m->get_tps();
        $datarunlink = $this->Daftarpemilihtetap_m->get_activedclass($this->susbtitle);
        if($datarunlink['tit_actclass']!=''){
            $arr_runlink = explode('/', $datarunlink['tit_actclass']);
            foreach ($arr_runlink as $showrun) {
                $contrunlink = $this->Daftarpemilihtetap_m->content_runlink($showrun);
    ...
    public function pagination(){
        ...
        $config = array();
        $config['base_url']    = "#";
        $config['total_rows']  = $this->Daftarpemilihtetap_m->count_all($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi);
        ...
        $output = array(
            ...
            'dpt_table'                 => $this->Daftarpemilihtetap_m->fetch_details($config["per_page"],$start,$namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$mylink,$jns_variansi),
            'content_double'            => $this->Daftarpemilihtetap_m->fetch_double($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi),
            'showCountData'             => $showCountData,
            'perpage'                   => $this->sumof_perpage,
            'jum_laki'                  => $this->Daftarpemilihtetap_m->jum_laki($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi),
            'jum_perempuan'             => $this->Daftarpemilihtetap_m->jum_perempuan($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi),
            'jum_keluarga'              => $this->Daftarpemilihtetap_m->jum_keluarga($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi),
            'jum_double'                => $this->Daftarpemilihtetap_m->jum_double($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi),
            'jum_cocok'                 => $this->Daftarpemilihtetap_m->jum_cocok($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi),
            'jum_ubah_data'             => $this->Daftarpemilihtetap_m->jum_ubah_data($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi),
            'jum_baru'                  => $this->Daftarpemilihtetap_m->jum_baru($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi),
            'jum_tms'                   => $this->Daftarpemilihtetap_m->jum_tms($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi),
            'jum_belum_rekam_ektp'      => $this->Daftarpemilihtetap_m->jum_belum_rekam_ektp($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi),

            'jum_meninggal'             => $this->Daftarpemilihtetap_m->jum_meninggal($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi),
            'jum_ditemukan_ganda'       => $this->Daftarpemilihtetap_m->jum_ditemukan_ganda($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi),
            'jum_dibawah_umur'          => $this->Daftarpemilihtetap_m->jum_dibawah_umur($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi),
            'jum_pindah_domisili'       => $this->Daftarpemilihtetap_m->jum_pindah_domisili($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi),
            'jum_tidak_ditemukan'       => $this->Daftarpemilihtetap_m->jum_tidak_ditemukan($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi),
            'jum_tni'                   => $this->Daftarpemilihtetap_m->jum_tni($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi),
            'jum_polri'                 => $this->Daftarpemilihtetap_m->jum_polri($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi),
            'jum_hilang_ingatan'        => $this->Daftarpemilihtetap_m->jum_hilang_ingatan($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi),
            'jum_hak_pilihdicabut'      => $this->Daftarpemilihtetap_m->jum_hak_pilihdicabut($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi),
            'jum_bukan_penduduk'        => $this->Daftarpemilihtetap_m->jum_bukan_penduduk($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi),
            'jum_disabilitas_fisik'     => $this->Daftarpemilihtetap_m->jum_disabilitas_fisik($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi),
            'jum_disabilitas_intelektual'=> $this->Daftarpemilihtetap_m->jum_disabilitas_intelektual($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi),
            'jum_tuna_mental'           => $this->Daftarpemilihtetap_m->jum_tuna_mental($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi),
            'jum_disabilitas_sensorik'  => $this->Daftarpemilihtetap_m->jum_disabilitas_sensorik($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi)
        );
    ...
    public function changeperpage(){
        ...
        $this->Daftarpemilihtetap_m->changePerpageValue($perpageValue,$id);
    }
    ...
    public function import(){
        $data = $this->Daftarpemilihtetap_m->select();
        $output = '
        ...
        if(isset($_FILES["file"]["name"])){
            ...
            foreach ($object->getWorksheetIterator() as $worksheet) {
                ...
                for($row=2; $row<=$highestRow; $row++){
                    ...
                    $id_tps = $this->Daftarpemilihtetap_m->checktps($tps);
            ...
            $this->Daftarpemilihtetap_m->insert($data);
    ...
    public function data_cocok(){
        ...
        if($selected!=''){
            ...
            foreach ($arr_kalimat as $id) {
                if($id!=''){
                    $this->Daftarpemilihtetap_m->cocok($id);
                }
            }
        }
    }
    public function data_tms(){
        ...
        if($selected!=''){
            ...
            foreach ($arr_kalimat as $id) {
                if($id!=''){
                    $this->Daftarpemilihtetap_m->tms($id,$category,$categories);
                }
            }
        }
    }
    public function data_pindah_tps(){
        ...
        if($selected!=''){
            ...
            foreach ($arr_kalimat as $id) {
                if($id!=''){
                    $no_tps = $this->Daftarpemilihtetap_m->chekinno_tps($id);
                    $tps_awal = $no_tps['tps'];
                    $no_tps2 = $this->Daftarpemilihtetap_m->chekcoutno_tps($tps);
                    $tps_akhir = $no_tps2['tps'];
                    if($tps_awal!=$tps_akhir){
                        $ket = $no_tps['ket_details']." [".date("Y-m-d H:i:s", time())."] : TPS ".$tps_awal." -> TPS ".$tps_akhir.";";
                        $this->Daftarpemilihtetap_m->pindahtps($id,$tps,$ket,$tps_akhir);
                    }
                }
            }
        }
    ...
    public function rekap(){
        ...
        $data['result'] = $this->Daftarpemilihtetap_m->get_rekap();
    ...
    public function edit($id){
        if($this->Daftarpemilihtetap_m->checkedit($id)==1){
            $data['subtitle'] = $this->susbtitle;
            $data['mylink'] = $this->linkwithoutspace;
            ...
            $data['results'] = $this->Daftarpemilihtetap_m->get_viewubahdata($id)->row_array();
    ...
    public function saveupdate(){
        ...
        $this->Daftarpemilihtetap_m->updateubahdata($id,$data);
    ...
    public function soft_delete(){
        ...
        if($selected!=''){
            ...
            foreach ($arr_kalimat as $id) {
                if($id!=''){
                    $checked = $this->Daftarpemilihtetap_m->checked($id);
                    if($checked>0){
                        $this->Daftarpemilihtetap_m->deleted($id);
                    }
                }
            }
        }
    ...
    public function export_excel(){
        ...
        $results = $this->Daftarpemilihtetap_m->show_data($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi);
        $excel_row =2;
        $no = 1;
        $sumberdata = "-";
    ...
    public function export_excel_mutakhir(){
        ...
        $results = $this->Daftarpemilihtetap_m->show_data_mutakhir($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi);
        $excel_row =2;
        $no = 1;
        $sumberdata = "-";
        foreach ($results as $row) {
    ...
    public function mutakhir(){
        ...
        $results = $this->Daftarpemilihtetap_m->show_mutakhir();
        ...
        $this->Daftarpemilihtetap_m->insert_mutakhir($data);
    ...
    public function paginations(){
        ...
        $config = array();
        $config['base_url']    = "#";
        $config['total_rows']  = $this->Daftarpemilihtetap_m->veri2_count_all($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi);
        $config['per_page']    = $this->sumof_perpage;
        $config['uri_segment'] = 3;
        $config['use_page_numbers'] = true;
        $config['full_tag_open'] = '<ul class="pagination">';
        ...
        $output = array(
            'pagination_link'           => $this->pagination->create_links(),
            'dpt_table'                 => $this->Daftarpemilihtetap_m->fetch_details2($config["per_page"],$start,$namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$mylink,$jns_variansi),
            'content_double'            => $this->Daftarpemilihtetap_m->veri2_fetch_double($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi),
            'showCountData'             => $showCountData,
            'perpage'                   => $this->sumof_perpage,
            'jum_laki'                  => $this->Daftarpemilihtetap_m->veri2_jum_laki($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi),
            'jum_perempuan'             => $this->Daftarpemilihtetap_m->veri2_jum_perempuan($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi),
            'jum_keluarga'              => $this->Daftarpemilihtetap_m->veri2_jum_keluarga($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi),
            'jum_double'                => $this->Daftarpemilihtetap_m->veri2_jum_double($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi),
            'jum_cocok'                 => $this->Daftarpemilihtetap_m->veri2_jum_cocok($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi),
            'jum_ubah_data'             => $this->Daftarpemilihtetap_m->veri2_jum_ubah_data($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi),
            'jum_baru'                  => $this->Daftarpemilihtetap_m->veri2_jum_baru($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi),
            'jum_belum_rekam_ektp'      => $this->Daftarpemilihtetap_m->veri2_jum_belum_rekam_ektp($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi),

            'jum_disabilitas_fisik'     => $this->Daftarpemilihtetap_m->veri2_jum_disabilitas_fisik($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi),
            'jum_disabilitas_intelektual'=> $this->Daftarpemilihtetap_m->veri2_jum_disabilitas_intelektual($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi),
            'jum_tuna_mental'           => $this->Daftarpemilihtetap_m->veri2_jum_tuna_mental($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi),
            'jum_disabilitas_sensorik'  => $this->Daftarpemilihtetap_m->veri2_jum_disabilitas_sensorik($namaalamat,$nikkk,$rt,$rw,$jns_kelamin,$jns_variansi)
        );
        echo json_encode($output);
    }
    ...
    public function rekap_final(){
        ...
        $jum_kk = $this->Daftarpemilihtetap_m->jumlah_kk();
        $data['jum_kk'] = $jum_kk['kk'];
        $data['jum_laki'] = $jum_kk['laki'];
        $data['jum_p'] = $jum_kk['perempuan'];
        $data['tot'] = $jum_kk['tot'];
        
        $jum_laki = $this->Daftarpemilihtetap_m->jumlah_laki();
        $data['jumlahlaki'] = $jum_laki['laki'];
        $jum_perempuan = $this->Daftarpemilihtetap_m->jumlah_perempuan();
        $data['jumlahperempuan'] = $jum_perempuan['perempuan'];
        $jum_tot = $this->Daftarpemilihtetap_m->jumlah_jnstot();
        $data['kelamintot'] = $jum_tot['kelamintot'];
        $data['result'] = $this->Daftarpemilihtetap_m->get_rekap_final();
